...
export default function OtherProjects({data, data2}) {
    return(
        <section style={{padding: '55px 0 70px'}} className="bg-g px-2 mx-2 rounded-4">
            <div className="container">
                ...
                <div className="d-none d-lg-block position-relative" style={styles.swiper}>
                                <Swiper
                ...
                <div className="d-block d-lg-none position-relative" style={styles.swiper}>
                                <Swiper
                                  modules={[Navigation, Pagination, Autoplay]}
                                  spaceBetween={50}
                                  slidesPerView={1}
